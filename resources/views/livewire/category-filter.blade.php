<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
        ...
        <aside>
            ...
            {{--Start Para restablecer filtros--}}
            <x-jet-button class="mt-4" wire:click="limpiar">
                Eliminar filtros
            </x-jet-button>
            {{--End Para restablecer filtros--}}
        </aside>

        <div class="md:col-span-2 lg:col-span-4">
            {{-- Start Tratamiento de productos en grid o lista --}}
            @if ($view === 'grid')
                            ...
                            <article class="flex">
                                ...
                                <div class="flex-1 py-4 px-6 flex flex-col">
                                    <div class="flex justify-between">
                                        <div>
                                            <h1 class="text-lg font-semibold text-neutral-700">{{$product->name}}</h1>
                                            <p class="font-bold text-sky-500"> {{$product->price}} €</p>
                                        </div>
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span class="text-neutral-500 text-sm">(24)</span>
                                        </div>
                                    </div>
            ...
            {{-- End Tratamiento de productos en grid o lista --}}
        </div>
